...
- **Kiểm tra:** `npm.cmd test` (40 pass), `npm.cmd run lint` (0 errors, 3 warning có sẵn), `npm.cmd run build` pass; Deno/Supabase integration chờ CI vì local không có runtime.
