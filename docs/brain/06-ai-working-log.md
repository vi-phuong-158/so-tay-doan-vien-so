...
- **Kiểm tra:** Frontend baseline gates chạy trên workspace tương đương: `npm test` 45/45 PASS, lint PASS, build PASS; Node syntax check cho OAuth bootstrap PASS; Supabase CLI, Docker, psql và Deno chưa có trong môi trường local. DB/pgTAP/Deno và exact-head CI vẫn là gate bắt buộc trước verdict.
