...
### P5 semantic retrieval integration reconciliation — IN PROGRESS
...
- **Trạng thái:** Preserve current public-first guest auth, hashed quota and public lexical corpus; retain hybrid lexical/semantic retrieval for authenticated users. Full post-merge validation and exact-head CI are pending.
- **Phạm vi:** conflict-safe integration only; no new retrieval behavior, production backfill, production deployment, or rehearsal E2E.
