...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', jsonb_build_object('sub', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'email', 'sysadmin@test.local', 'email_verified', true), 'email', 'sysadmin@test.local', now(), now(), now()),
('a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', 'a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', jsonb_build_object('sub', 'a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', 'email', 'sysadmin2@test.local', 'email_verified', true), 'email', 'sysadmin2@test.local', now(), now(), now()),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', jsonb_build_object('sub', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'email', 'youthadmin@test.local', 'email_verified', true), 'email', 'youthadmin@test.local', now(), now(), now()),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'cccccccc-cccc-cccc-cccc-cccccccccccc', jsonb_build_object('sub', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'email', 'officera@test.local', 'email_verified', true), 'email', 'officera@test.local', now(), now(), now()),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'dddddddd-dddd-dddd-dddd-dddddddddddd', jsonb_build_object('sub', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'email', 'officerb@test.local', 'email_verified', true), 'email', 'officerb@test.local', now(), now(), now()),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', jsonb_build_object('sub', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'email', 'member@test.local', 'email_verified', true), 'email', 'member@test.local', now(), now(), now()),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'ffffffff-ffff-ffff-ffff-ffffffffffff', jsonb_build_object('sub', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'email', 'innovation@test.local', 'email_verified', true), 'email', 'innovation@test.local', now(), now(), now()),
('11112222-3333-4444-5555-666677778888', '11112222-3333-4444-5555-666677778888', jsonb_build_object('sub', '11112222-3333-4444-5555-666677778888', 'email', 'youthadmina@test.local', 'email_verified', true), 'email', 'youthadmina@test.local', now(), now(), now()),
