...
insert into auth.users (
  ...
  confirmation_token, recovery_token, email_change_token_new, email_change, phone, phone_change, phone_change_token, email_change_token_current, reauthentication_token
) values 
('00000000-0000-0000-0000-000000000000', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'authenticated', 'authenticated', 'sysadmin@test.local', extensions.crypt('password123', extensions.gen_salt('bf', 10)), now(), jsonb_build_object('provider', 'email', 'providers', jsonb_build_array('email')), '{}'::jsonb, false, false, now(), now(), '', '', '', '', '', '', '', '', ''),
('00000000-0000-0000-0000-000000000000', 'a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', 'authenticated', 'authenticated', 'sysadmin2@test.local', extensions.crypt('password123', extensions.gen_salt('bf', 10)), now(), jsonb_build_object('provider', 'email', 'providers', jsonb_build_array('email')), '{}'::jsonb, false, false, now(), now(), '', '', '', '', '', '', '', '', ''),
('00000000-0000-0000-0000-000000000000', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'authenticated', 'authenticated', 'youthadmin@test.local', extensions.crypt('password123', extensions.gen_salt('bf', 10)), now(), jsonb_build_object('provider', 'email', 'providers', jsonb_build_array('email')), '{}'::jsonb, false, false, now(), now(), '', '', '', '', '', '', '', '', ''),
('00000000-0000-0000-0000-000000000000', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'authenticated', 'authenticated', 'officera@test.local', extensions.crypt('password123', extensions.gen_salt('bf', 10)), now(), jsonb_build_object('provider', 'email', 'providers', jsonb_build_array('email')), '{}'::jsonb, false, false, now(), now(), '', '', '', '', '', '', '', '', ''),
('00000000-0000-0000-0000-000000000000', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'authenticated', 'authenticated', 'officerb@test.local', extensions.crypt('password123', extensions.gen_salt('bf', 10)), now(), jsonb_build_object('provider', 'email', 'providers', jsonb_build_array('email')), '{}'::jsonb, false, false, now(), now(), '', '', '', '', '', '', '', '', ''),
...
(gen_random_uuid(), 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', jsonb_build_object('sub', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'email', 'sysadmin@test.local', 'email_verified', true, 'phone_verified', false), 'email', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', now(), now(), now()),
(gen_random_uuid(), 'a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', jsonb_build_object('sub', 'a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', 'email', 'sysadmin2@test.local', 'email_verified', true, 'phone_verified', false), 'email', 'a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', now(), now(), now()),
(gen_random_uuid(), 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', jsonb_build_object('sub', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'email', 'youthadmin@test.local', 'email_verified', true, 'phone_verified', false), 'email', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now(), now(), now()),
(gen_random_uuid(), 'cccccccc-cccc-cccc-cccc-cccccccccccc', jsonb_build_object('sub', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'email', 'officera@test.local', 'email_verified', true, 'phone_verified', false), 'email', 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now(), now()),
(gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddddd', jsonb_build_object('sub', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'email', 'officerb@test.local', 'email_verified', true, 'phone_verified', false), 'email', 'dddddddd-dddd-dddd-dddd-dddddddddddd', now(), now(), now()),
